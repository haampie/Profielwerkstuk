...
\begin{document}
	...
	Als eindproduct hebben we alle formules die we hebben opgesteld omgezet in een computerprogramma, waarmee we vrij nauwkeurige simulaties kunnen uitvoeren. We hebben gekozen voor een algemeen programma, waarmee derden zelf simulaties kunnen maken. Verder hebben we zelf een aantal voorbeelden gemaakt, om te laten zien wat de mogelijkheden zijn.
	
	\subsection{Wat zit erin?}
	\begin{description}
	...
	Als een simulatie wordt uitgevoerd, leest het programma eerst welke voorwerpen er zijn, welke eigenschappen die hebben en welke krachten er werken.
