...
Bij een niet-centrale botsing tussen twee ballen met dezelfde massa waarvan \'{e}\'{e}n bal geen snelheid heeft, zullen de ballen onder een hoek van 90° uit elkaar gaan na de botsing. 
	...
	\begin{figure}[H]
		...
		\,
		\subfloat[Simulate met ons programma]{\label{botsing3-simulatie}\includegraphics[width=0.45\textwidth]{Plaatjes/botsing3-simulatie.jpg}}
...
wereld.nieuwVoorwerp(cirkel4);
	...
	\begin{description}
		\item[Hoe werken botsingen bij poolballen?]\hfill \\
			
		\item[Met welke natuurkundige en wiskundige formules is de beweging te beschrijven?]\hfill \\
			
		\item[Hoe programmeer je deze formules?]\hfill \\
			
		\item[Hoe optimaliseer je de snelheid van het programma?]\hfill \\
