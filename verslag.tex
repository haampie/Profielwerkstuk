...
Je kunt $v_2$ op een zelfde soort manier berekenen. Dus $v_1$ en $v_2$ is:
	\begin{equation}
		\begin{aligned}
	...
	Bij een volkomen onelastische botsing is de gemmenschappelijke snelheid $v_g$ van beide voorwerpen gelijk aan \eqref{gemeenschappelijke-snelheid}. Bij een volkomen elastische centrale botsing is de snelheidsverandering van elk voorwerp gedurende de tweede periode van de botsing (op grond van de definitie van een elastische botsing) gelijk aan de snelheidsverandering gedurende de eerste periode van de botsing.
...
De uitkomst van \eqref{uitwerking-gemeenschappelijke-snelheid} komt overeen met de uitkomst van \eqref{uitwerking-energie-impuls}.
	...
	Wij werken alleen met botsingen in het platte vlak. Omdat we werken harde houten ballen, die vergelijkbaar zijn met biljartballen, hebben we te enkel maken met volkomen elastische botsingen.
